...
-define(distributed_pb_gpb_version, "4.19.5").
...
-record('SetupConfig',
        {label = []             :: unicode:chardata() | undefined, % = 1, optional
         data = []              :: unicode:chardata() | undefined % = 2, optional
        }).
-endif.
...
-record('TestFailure',
        {reason = []            :: unicode:chardata() | undefined % = 1, optional
        }).
-endif.
