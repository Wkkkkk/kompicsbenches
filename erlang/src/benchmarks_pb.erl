...
-type '$msg_name'() :: 'PingPongRequest' | 'ThroughputPingPongRequest' | 'AtomicRegisterRequest' | 'TestResult' | 'TestSuccess' | 'TestFailure' | 'NotImplemented' | 'ReadyRequest' | 'ReadyResponse' | 'ShutdownRequest' | 'ShutdownAck'.
-type '$msg'() :: 'PingPongRequest'() | 'ThroughputPingPongRequest'() | 'AtomicRegisterRequest'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'().
...
d_field_PingPongRequest_number_of_messages(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 18446744073709551615, TrUserData), Rest}, dfp_read_field_def_PingPongRequest(RestF, 0, 0, F, NewFValue, TrUserData).
...
skip_length_delimited_PingPongRequest(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_PingPongRequest(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_PingPongRequest(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_PingPongRequest(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
d_field_ThroughputPingPongRequest_messages_per_pair(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 18446744073709551615, TrUserData), Rest}, dfp_read_field_def_ThroughputPingPongRequest(RestF, 0, 0, F, NewFValue, F@_2, F@_3, F@_4, TrUserData).
...
d_field_ThroughputPingPongRequest_pipeline_size(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 18446744073709551615, TrUserData), Rest}, dfp_read_field_def_ThroughputPingPongRequest(RestF, 0, 0, F, F@_1, NewFValue, F@_3, F@_4, TrUserData).
...
d_field_ThroughputPingPongRequest_parallelism(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, F@_4, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 4294967295, TrUserData), Rest}, dfp_read_field_def_ThroughputPingPongRequest(RestF, 0, 0, F, F@_1, F@_2, NewFValue, F@_4, TrUserData).
...
d_field_ThroughputPingPongRequest_static_only(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_ThroughputPingPongRequest(RestF, 0, 0, F, F@_1, F@_2, F@_3, NewFValue, TrUserData).
...
skip_length_delimited_ThroughputPingPongRequest(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ThroughputPingPongRequest(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_group_ThroughputPingPongRequest(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ThroughputPingPongRequest(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData).
...
d_field_AtomicRegisterRequest_partition_size(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, F@_4, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 4294967295, TrUserData), Rest}, dfp_read_field_def_AtomicRegisterRequest(RestF, 0, 0, F, F@_1, F@_2, NewFValue, F@_4, TrUserData).
...
d_field_AtomicRegisterRequest_number_of_keys(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, _, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 18446744073709551615, TrUserData), Rest}, dfp_read_field_def_AtomicRegisterRequest(RestF, 0, 0, F, F@_1, F@_2, F@_3, NewFValue, TrUserData).
...
skip_length_delimited_AtomicRegisterRequest(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_AtomicRegisterRequest(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_group_AtomicRegisterRequest(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_AtomicRegisterRequest(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData).
...
get_msg_defs() ->
    [{{msg, 'PingPongRequest'}, [#field{name = number_of_messages, fnum = 1, rnum = 2, type = uint64, occurrence = optional, opts = []}]},
     {{msg, 'ThroughputPingPongRequest'},
      [#field{name = messages_per_pair, fnum = 1, rnum = 2, type = uint64, occurrence = optional, opts = []}, #field{name = pipeline_size, fnum = 2, rnum = 3, type = uint64, occurrence = optional, opts = []},
       #field{name = parallelism, fnum = 3, rnum = 4, type = uint32, occurrence = optional, opts = []}, #field{name = static_only, fnum = 4, rnum = 5, type = bool, occurrence = optional, opts = []}]},
     {{msg, 'AtomicRegisterRequest'},
      [#field{name = read_workload, fnum = 1, rnum = 2, type = float, occurrence = optional, opts = []}, #field{name = write_workload, fnum = 2, rnum = 3, type = float, occurrence = optional, opts = []},
       #field{name = partition_size, fnum = 3, rnum = 4, type = uint32, occurrence = optional, opts = []}, #field{name = number_of_keys, fnum = 4, rnum = 5, type = uint64, occurrence = optional, opts = []}]},
     {{msg, 'TestResult'},
...
get_msg_names() -> ['PingPongRequest', 'ThroughputPingPongRequest', 'AtomicRegisterRequest', 'TestResult', 'TestSuccess', 'TestFailure', 'NotImplemented', 'ReadyRequest', 'ReadyResponse', 'ShutdownRequest', 'ShutdownAck'].


get_group_names() -> [].


get_msg_or_group_names() -> ['PingPongRequest', 'ThroughputPingPongRequest', 'AtomicRegisterRequest', 'TestResult', 'TestSuccess', 'TestFailure', 'NotImplemented', 'ReadyRequest', 'ReadyResponse', 'ShutdownRequest', 'ShutdownAck'].
...
get_rpc_names('BenchmarkRunner') -> ['Ready', 'Shutdown', 'PingPong', 'NetPingPong', 'ThroughputPingPong', 'NetThroughputPingPong', 'AtomicRegister'];
...
get_msg_containment("benchmarks") -> ['AtomicRegisterRequest', 'PingPongRequest', 'ThroughputPingPongRequest'];
...
get_rpc_containment("benchmarks") ->
    [{'BenchmarkRunner', 'Ready'}, {'BenchmarkRunner', 'Shutdown'}, {'BenchmarkRunner', 'PingPong'}, {'BenchmarkRunner', 'NetPingPong'}, {'BenchmarkRunner', 'ThroughputPingPong'}, {'BenchmarkRunner', 'NetThroughputPingPong'},
