...
-type '$msg_name'() :: 'ClientInfo' | 'CheckinResponse' | 'SetupConfig' | 'SetupResponse' | 'CleanupInfo' | 'CleanupResponse' | 'TestResult' | 'TestSuccess' | 'TestFailure' | 'NotImplemented' | 'ReadyRequest' | 'ReadyResponse' | 'ShutdownRequest' | 'ShutdownAck'.
-type '$msg'() :: 'ClientInfo'() | 'CheckinResponse'() | 'SetupConfig'() | 'SetupResponse'() | 'CleanupInfo'() | 'CleanupResponse'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'().
...
e_mfield_TestResult_success(Msg, Bin, TrUserData) -> SubBin = encode_msg_TestSuccess(Msg, <<>>, TrUserData), Bin2 = e_varint(byte_size(SubBin), Bin), <<Bin2/binary, SubBin/binary>>.

e_mfield_TestResult_failure(Msg, Bin, TrUserData) -> SubBin = encode_msg_TestFailure(Msg, <<>>, TrUserData), Bin2 = e_varint(byte_size(SubBin), Bin), <<Bin2/binary, SubBin/binary>>.

e_mfield_TestResult_not_implemented(_Msg, Bin, _TrUserData) -> <<Bin/binary, 0>>.

e_field_TestSuccess_run_results(Elems, Bin, TrUserData) when Elems =/= [] -> Bin2 = <<Bin/binary, 18>>, Bin3 = e_varint(length(Elems) * 8, Bin2), e_pfield_TestSuccess_run_results(Elems, Bin3, TrUserData);
...
d_field_ClientInfo_address(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Utf8:Len/binary, Rest2/binary>> = Rest, {id(unicode:characters_to_list(Utf8, unicode), TrUserData), Rest2} end, dfp_read_field_def_ClientInfo(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).
...
d_field_ClientInfo_port(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, TrUserData) -> {NewFValue, RestF} = {id((X bsl N + Acc) band 4294967295, TrUserData), Rest}, dfp_read_field_def_ClientInfo(RestF, 0, 0, F, F@_1, NewFValue, TrUserData).
...
skip_length_delimited_ClientInfo(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ClientInfo(Rest2, 0, 0, F, F@_1, F@_2, TrUserData).

skip_group_ClientInfo(Bin, _, Z2, FNum, F@_1, F@_2, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ClientInfo(Rest, 0, Z2, FNum, F@_1, F@_2, TrUserData).
...
skip_length_delimited_CheckinResponse(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_CheckinResponse(Rest2, 0, 0, F, TrUserData).

skip_group_CheckinResponse(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_CheckinResponse(Rest, 0, Z2, FNum, TrUserData).
...
d_field_SetupConfig_label(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Utf8:Len/binary, Rest2/binary>> = Rest, {id(unicode:characters_to_list(Utf8, unicode), TrUserData), Rest2} end, dfp_read_field_def_SetupConfig(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).
...
d_field_SetupConfig_data(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Utf8:Len/binary, Rest2/binary>> = Rest, {id(unicode:characters_to_list(Utf8, unicode), TrUserData), Rest2} end, dfp_read_field_def_SetupConfig(RestF, 0, 0, F, F@_1, NewFValue, TrUserData).
...
skip_length_delimited_SetupConfig(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_SetupConfig(Rest2, 0, 0, F, F@_1, F@_2, TrUserData).

skip_group_SetupConfig(Bin, _, Z2, FNum, F@_1, F@_2, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_SetupConfig(Rest, 0, Z2, FNum, F@_1, F@_2, TrUserData).
...
d_field_SetupResponse_success(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) -> {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_SetupResponse(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).
...
d_field_SetupResponse_data(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Utf8:Len/binary, Rest2/binary>> = Rest, {id(unicode:characters_to_list(Utf8, unicode), TrUserData), Rest2} end, dfp_read_field_def_SetupResponse(RestF, 0, 0, F, F@_1, NewFValue, TrUserData).
...
skip_length_delimited_SetupResponse(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_SetupResponse(Rest2, 0, 0, F, F@_1, F@_2, TrUserData).

skip_group_SetupResponse(Bin, _, Z2, FNum, F@_1, F@_2, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_SetupResponse(Rest, 0, Z2, FNum, F@_1, F@_2, TrUserData).
...
d_field_CleanupInfo_final(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) -> {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_CleanupInfo(RestF, 0, 0, F, NewFValue, TrUserData).
...
skip_length_delimited_CleanupInfo(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_CleanupInfo(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_CleanupInfo(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_CleanupInfo(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
skip_length_delimited_CleanupResponse(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_CleanupResponse(Rest2, 0, 0, F, TrUserData).

skip_group_CleanupResponse(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_CleanupResponse(Rest, 0, Z2, FNum, TrUserData).
...
d_field_TestResult_success(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, TrUserData) ->
    ...
    dfp_read_field_def_TestResult(RestF, 0, 0, F,
				  case Prev of
...
skip_length_delimited_TestResult(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_TestResult(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_TestResult(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_TestResult(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
d_field_TestSuccess_number_of_runs(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 4294967295, TrUserData), Rest}, dfp_read_field_def_TestSuccess(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).
...
d_pfield_TestSuccess_run_results(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, E, TrUserData) ->
    Len = X bsl N + Acc, <<PackedBytes:Len/binary, Rest2/binary>> = Rest, NewSeq = d_packed_field_TestSuccess_run_results(PackedBytes, 0, 0, F, E, TrUserData), dfp_read_field_def_TestSuccess(Rest2, 0, 0, F, F@_1, NewSeq, TrUserData).
...
skip_length_delimited_TestSuccess(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_TestSuccess(Rest2, 0, 0, F, F@_1, F@_2, TrUserData).

skip_group_TestSuccess(Bin, _, Z2, FNum, F@_1, F@_2, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_TestSuccess(Rest, 0, Z2, FNum, F@_1, F@_2, TrUserData).
...
d_field_TestFailure_reason(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Utf8:Len/binary, Rest2/binary>> = Rest, {id(unicode:characters_to_list(Utf8, unicode), TrUserData), Rest2} end, dfp_read_field_def_TestFailure(RestF, 0, 0, F, NewFValue, TrUserData).
...
skip_length_delimited_TestFailure(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_TestFailure(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_TestFailure(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_TestFailure(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
skip_length_delimited_NotImplemented(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_NotImplemented(Rest2, 0, 0, F, TrUserData).

skip_group_NotImplemented(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_NotImplemented(Rest, 0, Z2, FNum, TrUserData).
...
skip_length_delimited_ReadyRequest(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ReadyRequest(Rest2, 0, 0, F, TrUserData).

skip_group_ReadyRequest(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ReadyRequest(Rest, 0, Z2, FNum, TrUserData).
...
d_field_ReadyResponse_status(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) -> {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_ReadyResponse(RestF, 0, 0, F, NewFValue, TrUserData).
...
skip_length_delimited_ReadyResponse(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ReadyResponse(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_ReadyResponse(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ReadyResponse(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
d_field_ShutdownRequest_force(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) -> {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_ShutdownRequest(RestF, 0, 0, F, NewFValue, TrUserData).
...
skip_length_delimited_ShutdownRequest(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ShutdownRequest(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_ShutdownRequest(Bin, _, Z2, FNum, F@_1, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ShutdownRequest(Rest, 0, Z2, FNum, F@_1, TrUserData).
...
skip_length_delimited_ShutdownAck(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) -> Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_ShutdownAck(Rest2, 0, 0, F, TrUserData).

skip_group_ShutdownAck(Bin, _, Z2, FNum, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_ShutdownAck(Rest, 0, Z2, FNum, TrUserData).
...
v_msg_TestSuccess(#'TestSuccess'{number_of_runs = F1, run_results = F2}, Path, TrUserData) ->
    ...
    if is_list(F2) -> _ = [v_type_double(Elem, [run_results | Path], TrUserData) || Elem <- F2], ok;
...
get_msg_defs() ->
    [{{msg, 'ClientInfo'}, [#field{name = address, fnum = 1, rnum = 2, type = string, occurrence = optional, opts = []}, #field{name = port, fnum = 2, rnum = 3, type = uint32, occurrence = optional, opts = []}]}, {{msg, 'CheckinResponse'}, []},
     ...
     {{msg, 'CleanupInfo'}, [#field{name = final, fnum = 1, rnum = 2, type = bool, occurrence = optional, opts = []}]}, {{msg, 'CleanupResponse'}, []},
     {{msg, 'TestResult'},
      [#gpb_oneof{name = sealed_value, rnum = 2,
		  fields =
		      [#field{name = success, fnum = 1, rnum = 2, type = {msg, 'TestSuccess'}, occurrence = optional, opts = []}, #field{name = failure, fnum = 2, rnum = 2, type = {msg, 'TestFailure'}, occurrence = optional, opts = []},
     ...
     {{msg, 'TestFailure'}, [#field{name = reason, fnum = 1, rnum = 2, type = string, occurrence = optional, opts = []}]}, {{msg, 'NotImplemented'}, []}, {{msg, 'ReadyRequest'}, []},
     {{msg, 'ReadyResponse'}, [#field{name = status, fnum = 1, rnum = 2, type = bool, occurrence = optional, opts = []}]}, {{msg, 'ShutdownRequest'}, [#field{name = force, fnum = 1, rnum = 2, type = bool, occurrence = optional, opts = []}]},
     {{msg, 'ShutdownAck'}, []}].
