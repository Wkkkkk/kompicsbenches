...
-type '$msg_name'() :: 'TestResult' | 'TestSuccess' | 'TestFailure' | 'NotImplemented' | 'ReadyRequest' | 'ReadyResponse' | 'ShutdownRequest' | 'ShutdownAck'.
-type '$msg'() :: 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'().
