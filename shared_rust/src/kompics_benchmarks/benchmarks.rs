...
impl AtomicBroadcastRequest {
    ...
    // Param is passed by value, moved
    pub fn set_data_size(&mut self, v: u64) {
        self.data_size = v;
    }

    // double compression_rate = 10;


    pub fn get_compression_rate(&self) -> f64 {
        self.compression_rate
    }
    pub fn clear_compression_rate(&mut self) {
        self.compression_rate = 0.;
    }

    // Param is passed by value, moved
    pub fn set_compression_rate(&mut self, v: f64) {
        self.compression_rate = v;
    }

    // uint64 preprocessing_time = 11;


    pub fn get_preprocessing_time(&self) -> u64 {
        self.preprocessing_time
    }
    pub fn clear_preprocessing_time(&mut self) {
        self.preprocessing_time = 0;
    }

    // Param is passed by value, moved
    pub fn set_preprocessing_time(&mut self, v: u64) {
        self.preprocessing_time = v;
    }
}
...
impl ::protobuf::Message for AtomicBroadcastRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.data_size != 0 {
            my_size += ::protobuf::rt::value_size(9, self.data_size, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.compression_rate != 0. {
            my_size += 9;
        }
        if self.preprocessing_time != 0 {
            my_size += ::protobuf::rt::value_size(11, self.preprocessing_time, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.data_size != 0 {
            os.write_uint64(9, self.data_size)?;
        }
        if self.compression_rate != 0. {
            os.write_double(10, self.compression_rate)?;
        }
        if self.preprocessing_time != 0 {
            os.write_uint64(11, self.preprocessing_time)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "probability",
                    |m: &AtomicBroadcastRequest| { &m.probability },
                    |m: &mut AtomicBroadcastRequest| { &mut m.probability },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "data_size",
                    |m: &AtomicBroadcastRequest| { &m.data_size },
                    |m: &mut AtomicBroadcastRequest| { &mut m.data_size },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "compression_rate",
                    |m: &AtomicBroadcastRequest| { &m.compression_rate },
                    |m: &mut AtomicBroadcastRequest| { &mut m.compression_rate },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "preprocessing_time",
                    |m: &AtomicBroadcastRequest| { &m.preprocessing_time },
                    |m: &mut AtomicBroadcastRequest| { &mut m.preprocessing_time },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    numberOfNodes\x12\x1d\n\nblock_size\x18\x02\x20\x01(\rR\tblockSize\"\xd8\
    ...
    \x10network_scenario\x18\x07\x20\x01(\tR\x0fnetworkScenario\x12\x20\n\
    \x0bprobability\x18\x08\x20\x01(\x01R\x0bprobability\x12\x1b\n\tdata_siz\
    e\x18\t\x20\x01(\x04R\x08dataSize\x12)\n\x10compression_rate\x18\n\x20\
    \x01(\x01R\x0fcompressionRate\x12-\n\x12preprocessing_time\x18\x0b\x20\
    \x01(\x04R\x11preprocessingTime2\xbf\x08\n\x0fBenchmarkRunner\x12L\n\x05\
    Ready\x12\x20.kompics.benchmarks.ReadyRequest\x1a!.kompics.benchmarks.Re\
    adyResponse\x12P\n\x08Shutdown\x12#.kompics.benchmarks.ShutdownRequest\
    \x1a\x1f.kompics.benchmarks.ShutdownAck\x12O\n\x08PingPong\x12#.kompics.\
    benchmarks.PingPongRequest\x1a\x1e.kompics.benchmarks.TestResult\x12R\n\
    \x0bNetPingPong\x12#.kompics.benchmarks.PingPongRequest\x1a\x1e.kompics.\
    benchmarks.TestResult\x12c\n\x12ThroughputPingPong\x12-.kompics.benchmar\
    ks.ThroughputPingPongRequest\x1a\x1e.kompics.benchmarks.TestResult\x12f\
    \n\x15NetThroughputPingPong\x12-.kompics.benchmarks.ThroughputPingPongRe\
    quest\x1a\x1e.kompics.benchmarks.TestResult\x12[\n\x0eAtomicRegister\x12\
    ).kompics.benchmarks.AtomicRegisterRequest\x1a\x1e.kompics.benchmarks.Te\
    stResult\x12_\n\x10StreamingWindows\x12+.kompics.benchmarks.StreamingWin\
    dowsRequest\x1a\x1e.kompics.benchmarks.TestResult\x12Q\n\tFibonacci\x12$\
    .kompics.benchmarks.FibonacciRequest\x1a\x1e.kompics.benchmarks.TestResu\
    lt\x12Q\n\tChameneos\x12$.kompics.benchmarks.ChameneosRequest\x1a\x1e.ko\
    mpics.benchmarks.TestResult\x12W\n\x14AllPairsShortestPath\x12\x1f.kompi\
    cs.benchmarks.APSPRequest\x1a\x1e.kompics.benchmarks.TestResult\x12]\n\
